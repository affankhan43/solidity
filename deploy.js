...
async function Players() {
	var account = await web3.eth.getAccounts();
	lottery = await new web3.eth.Contract(abi,"0x39fcd315a6168633b7aba52cd9d30ae55fa4bec1")
	var message = await lottery.methods.setMessage("This is my new Message").send({"from":account[0]})
	//var message = await lottery.methods.getMessage().call()
	console.log(message)
}
Players()
//deploy()
